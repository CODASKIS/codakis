...
export default function PrivacyPolicyPage() {
  ...
  const highlights = useMemo(
    () => t("privacy.highlights", { returnObjects: true }) as LegalHighlight[],
    [t],
  );
  const fullSections = useMemo(
    () => t("privacy.fullSections", { returnObjects: true }) as LegalSection[],
    [t],
  );

  return (
    <>
      <PageMeta title={t("privacy.metaTitle")} description={t("privacy.metaDescription")} />
        ...
        <div className="fj-container fj-privacy-page__container">
          ...
          <header className="fj-privacy-page__header">
            ...
            <p className="fj-privacy-page__updated">
              {t("privacy.lastUpdatedLabel", { date: t("privacy.lastUpdated") })}
            </p>
            <p className="fj-privacy-page__intro">{t("privacy.intro")}</p>
          </header>

          <section className="fj-privacy-page__highlights" aria-labelledby="privacy-highlights-title">
            <h2 id="privacy-highlights-title">{t("privacy.highlightsTitle")}</h2>
            <p className="fj-privacy-page__highlights-note">
              {t("privacy.highlightsNoteBefore")}{" "}
              <a href="#politique-complete" className="fj-link">
                {t("privacy.highlightsNoteLink")}
              </a>
              {t("privacy.highlightsNoteAfter")}
            </p>
          ...
          <section
            ...
            aria-labelledby="privacy-full-title"
          >
            <h2 id="privacy-full-title">{t("privacy.fullTitle")}</h2>
