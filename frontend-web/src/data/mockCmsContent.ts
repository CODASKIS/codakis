...
export const MOCK_VITRINE_PLANS: VitrinePlanItem[] = [
  ...
  },
  {
    ...
    sticker: "Auto-école",
    title: "Partenaire",
    location: "Cameroun — Douala, Yaoundé",
    price_label: "25 000 FCFA / mois",
    highlight: "Visibilité dans l'annuaire agréé CODAKIS",
    description:
      "Publiez vos forfaits (code seul, conduite seule, complet), recevez des inscriptions qualifiées et encaissez par Mobile Money.",
  ...
  },
  {
    ...
    description:
      "Gestion des inscriptions, affectation moniteurs, calendrier partagé candidat/moniteur et tableau de bord pour auto-écoles multi-moniteurs.",
